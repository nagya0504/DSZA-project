...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Dec 11. 14:41
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `selectUserByEmail` (IN `email` VARCHAR(50), IN `pwd` VARCHAR(100))   SELECT * 
FROM `user` 
WHERE `user`.`email` = email AND `user`.`pwd` = SHA2(pwd, 256)$$
...
(1, 1, 'asd', 'asd asd', 0, 'valami szép könyv', 'C:\\project-img\\card-img', 4, '2023-09-26 08:19:50', '2023-11-23 08:40:56'),
